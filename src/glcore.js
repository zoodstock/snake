...
(function (root) {
  ...
  const INSTANCE_FLOATS = 11; // offset(3) + scale(3) + rot/emissive(2) + color(3)
  ...
  root.GLCore = { ATTR, INSTANCE_FLOATS, createContext, Program, Mesh, InstanceBatch, cubeGeometry, quadGeometry };
