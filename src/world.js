...
(function (root, factory) {
...
})(typeof globalThis !== 'undefined' ? globalThis : this, function (SnakeSim) {
  'use strict';

  const Snake = SnakeSim.Snake;
  ...
  const RIVAL_TINTS = 4;   // renderer maps 0..3 to distinct palettes
  ...
  return { World, CFG, mulberry32, RIVAL_TINTS };
});
